...
Typescript | NodeJS | NoSQL | VueJS | TailwindCSS | ViteJS | Framework7 | Ionic | CapacitorJS | Apache Cordova | Bootstrap | Firebase Realtime, Authentication, Storage, Functions, Messaging | Google Cloud
