...
( Javascript | NodeJS | NoSQL | Vue | Vuetify | Framework7 | Express | | CSS | HTML | Capacitor | Apache Cordova | Bootstrap | Vite | Jquery | Firebase Realtime, Authentication, Storage, Functions, Messaging | Google Cloud )
