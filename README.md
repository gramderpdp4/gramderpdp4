...
( NodeJS | Typescript | NoSQL | Vue | Framework7 | Ionic | ExpressJS | TailwindCSS | CSS3 | HTML5 | CapacitorJS | Apache Cordova | Bootstrap | ViteJS | Firebase Realtime, Authentication, Storage, Functions, Messaging | Google Cloud )
