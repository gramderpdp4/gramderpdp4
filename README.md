...
( Javascript ES6+ | NodeJS | NoSQL | Vue | Vuetify | Quasar | PrimeVue | Framework7 | Express | CSS | HTML | Capacitor | Apache Cordova | Bootstrap | Vite | Firebase Realtime, Authentication, Storage, Functions, Messaging | Google Cloud )
