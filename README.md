...
( Javascript | NodeJS | NoSQL | VueJS | Framework7 | CSS | HTML | CapacitorJS | Apache Cordova | Bootstrap5 | ViteJS | Firebase Realtime, Authentication, Storage, Functions, Messaging )
